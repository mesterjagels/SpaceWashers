...
namespace Destructible2D
{
	...
	public class D2dCleanPixels: MonoBehaviour
	{
		...
		{
			if (Input.GetKey(KeyCode.Space) == true && Camera.main != null)
			{
				var ray      = Camera.main.ScreenPointToRay(GameObject.FindGameObjectWithTag("Player").transform.position);
